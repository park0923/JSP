        ...
        <div class="details">
            <div class="screen">
                ...
                <div class="btn_seat">
                    ...
                    <button class="seat" id="4" value="0" style="margin-right: 20px"></button>
                    ...
                    <button class="seat" id="12" value="0" style="margin-right: 20px"></button>
                    ...
                    <button class="seat" id="20" value="0" style="margin-right: 20px"></button>
                    ...
                    <button class="seat" id="28" value="0"  style="margin-right: 20px"></button>
                    ...
                    <button class="seat" id="36" value="0" style="margin-right: 20px"></button>
            ...
            <div class="check">
                <form id="frm" name="seatForm" method="post" action="reservationProcess.jsp">
                    <div class="check_1">
                        강의실:
                        <input type="text" name="lectureRoom" value="<%= roomNum%>" style="padding: 5px" readonly>
                        날짜:
                        <input type="text" name="date" value="<%= request.getParameter("date")%>" style="padding: 5px" readonly>
                    </div>
                        <br>
                    <div class="check_2">
                        시간:
                        <input type="text" id="time" name="startTime" value="<%= request.getParameter("startTime")%> ~ <%= request.getParameter("endTime")%>" style="padding: 5px; margin-left: 16px" readonly>
                        인원:
                        <input type="text" id="person" value="<%= request.getParameter("person")%>" style="padding: 5px" readonly>
